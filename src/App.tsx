...
function App() {
  ...
  <p style={{ margin: 0 }}>Macmillan</p>
                    ...
                    <ul>
                        <li>
                            <a href="https://recruiting.ultipro.com/HOL1002HPHM/JobBoard/be27b89b-3cb9-491f-a1b0-42f8b077a9dd/OpportunityDetail?opportunityId=eb5b46d3-6b8d-4089-a7de-d83ceb68e207"
                               target="_blank">
                                Assistant, Performance Marketing & Audience(New York, NY)
                            </a>
                        </li>
                        <li>
  ...
  <p style={{ margin: 0 }}>Hachette Book Group</p>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="https://jobs.jobvite.com/hachette-book-group/job/oWvPzfwz" target="_blank">
                                Summer 2026 Orbit Marketing and Publicity Internship (New York, New York)
                            </a>
                        </li>
                        <li>
